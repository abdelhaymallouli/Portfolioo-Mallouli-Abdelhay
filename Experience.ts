...
export const EXPERIENCES: Experience[] = [
  {
    ...
    description:
      "Advanced specialization in Native Android development and enterprise-grade web architectures with a focus on DevOps, automated testing, and network infrastructure.",
    certificate: {
...

  {
    ...
    description:
      "Architected and deployed a suite of production-ready Mattermost plugins and Go-based microservices to automate enterprise workflows and HR compliance.",
...

  {
    ...
    description:
      "Comprehensive training following the 'Active Pedagogy' model, covering the full development lifecycle from UI/UX design to advanced back-end systems.",
    certificate: {
