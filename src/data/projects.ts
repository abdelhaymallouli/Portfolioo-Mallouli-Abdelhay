...
export const projects: Project[] = [
  ...
  // 2. THE BUSINESS CASE: This proves you understand ROI (Return on Investment).
  {
    ...
    description:
      "An empathetic EdTech solution reducing 'Paper-to-Laptop' friction. This system automates administrative workflows, solving a 70% time-loss gap identified during the Empathy Phase of research.",
    ...
    technicalChallenges: [
      "Reducing a massive 70% time-loss gap caused by manual 'Paper-to-Laptop' data entry.",
      "Automating complex and highly variable administrative workflows.",
    ],
    solutions: [
      "Built a streamlined, empathetic UI tailored specifically for non-technical administrative staff.",
      "Created a modular backend architecture to dynamically map varying workflows.",
    ],
    link: "",
  ...
  // 3. THE MODERN FULL-STACK: This checks the React/TypeScript box.
  {
    ...
    description:
      "A professional full-stack marketplace bridging venue owners and event planners. Features automated booking workflows and a robust administrative control panel for vendor management.",
    ...
    technicalChallenges: [
      "Managing a massive state tree for filtering events across multiple dates and categories concurrently.",
      "Creating a highly-secure vendor dashboard while enabling fast client queries.",
    ],
    solutions: [
      "Decoupled state management using custom React hooks to isolate complex logic.",
      "Optimized MySQL joins and caching mechanisms to ensure sub-100ms response times for venue owners.",
    ],
...

  {
    ...
    description:
      "A data-driven budget tracking application featuring a dynamic dashboard for real-time financial insights. Visualizes transaction data to help users manage capital effectively.",
...

  {
    ...
    description:
      "A secure ticketing solution architected for high data integrity. Implements advanced filtering and a secure end-to-end booking flow using modern security standards.",
  ...
  // 6. THE PROCESS BUILDER: Shows complex business logic (Ordering/Kitchen/Admin).
  {
    ...
    description:
      "An E-commerce solution optimizing food delivery workflows. Connects customer interfaces with data-driven admin dashboards for real-time order tracking.",
  ...
  // 7. THE UX SPECIALIST: Shows attention to detail and customer experience.
  {
    ...
    description:
      "An online bookstore interface focused on user experience. Features dynamic book discovery, category-based filtering, and a persistence-based wishlist.",
  ...
  // 8. THE INTEGRATOR: Demonstrates API skills and Python knowledge.
  {
    ...
    title: "WeatherWise",
    description:
      "A technical demonstration of API orchestration. Converts raw meteorological data into actionable user insights via a clean, desktop-optimized interface.",
  ...
  // 9. THE SEO/MARKETING AWARE: Shows you understand the web beyond just code.
  {
    ...
    description:
      "A local-SEO directory application designed with a mobile-first approach. Focuses on dynamic data rendering and accessible design for local business growth.",
  ...
  // 10. THE FOUNDATION: Proves you know vanilla JavaScript deeply.
  {
    ...
    description:
      "A high-performance frontend case study. Implements efficient state management using Vanilla JavaScript for zero-latency interactions.",
